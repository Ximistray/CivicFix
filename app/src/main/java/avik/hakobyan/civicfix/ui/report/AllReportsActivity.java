...
public class AllReportsActivity extends AppCompatActivity {
    ...
    private static final String TAG = "AllReportsActivity";
    ...
    private int selectedRegionTab = 0; // 0: My Region, 1: All Regions
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle(R.string.all_reports);
        }
    ...
    private void showFilterDialog() {
        ...
        if (regionTabs != null) {
            TabLayout.Tab currentRegionTab = regionTabs.getTabAt(selectedRegionTab);
            if (currentRegionTab != null) currentRegionTab.select();
        }
        
        if (statusTabs != null) {
            TabLayout.Tab currentStatusTab = statusTabs.getTabAt(selectedStatusTab);
            if (currentStatusTab != null) currentStatusTab.select();
        }
    ...
    private void applyFilter() {
        ...
        for (Problem p : allReports) {
            ...
            // Search Match (Type or Description)
    ...
    private void sortReportsByVotes() {
        Collections.sort(filteredReports, (p1, p2) -> Integer.compare(p2.getVoteCount(), p1.getVoteCount()));
    }
    ...
    private void loadReports() {
        if (isInitialLoad) progressBar.setVisibility(View.VISIBLE);
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                if (isInitialLoad) progressBar.setVisibility(View.GONE);
            }
        });
    }
